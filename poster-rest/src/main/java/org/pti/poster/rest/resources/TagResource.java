...
public class TagResource {
    ...
    public void addPostTag(@RequestBody Post.Tag tag, @PathVariable BigInteger id, HttpServletResponse response) {
    ...
    private void removeOldPostAndCreateNew(BigInteger oldPostId, HttpServletResponse response, ArrayList<Post.Tag> tags, String text) {
